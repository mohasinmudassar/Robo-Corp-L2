...
#    ${username}=    Get The User Name
    ...
    FOR    ${row}    IN    @{orders}
        ...
        Fill the form    ${row}
        Wait Until Keyword Succeeds    10x    10s    Preview the robot
        Wait Until Keyword Succeeds    10x    5s    Submit The Order
        ${orderid}    ${img_filename}=    Wait Until Keyword Succeeds
        ...    5x
        ...    0.5 sec
...
Close the annoying modal
    ...
    Click Button When Visible    ${btn_yep}
#    Wait And Click Button    ${btn_yep}
#    Click Button    OK
#    Click Button When Visible    OK
...
Fill the form
    ...
    #Setting Local Variables with X path
...
Take a screenshot of the robot
    Set Local Variable    ${lbl_orderid}    xpath://html/body/div/div/div[1]/div/div[1]/form/button[2]
    Set Local Variable    ${img_robot}    //*[@id="robot-preview-image"]
    Wait Until Element Is Visible    ${img_robot}
    Click Button    ${lbl_orderid}
...
#Get The User Name
#    Add heading    I am your RoboCorp Assistant
